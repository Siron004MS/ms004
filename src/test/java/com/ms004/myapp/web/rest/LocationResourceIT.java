...
import static com.ms004.myapp.domain.LocationAsserts.*;
import static com.ms004.myapp.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.ms004.myapp.domain.Location;
import com.ms004.myapp.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.streetAddress(UPDATED_STREET_ADDRESS).postalCode(UPDATED_POSTAL_CODE);

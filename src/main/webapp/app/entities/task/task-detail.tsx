    ...
    <Row>
      <Col md="8">
        <h2 data-cy="taskDetailsHeading">
          <Translate contentKey="ms004App.task.detail.title">Task</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="ms004App.task.title">Title</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="ms004App.task.job">Job</Translate>
          </dt>
          <dd>
            {taskEntity.jobs
